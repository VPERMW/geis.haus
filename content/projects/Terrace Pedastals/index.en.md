---
title: "Terrace Pedestal Redesign"
summary: "A bachelor's thesis redesigning the terrace pedestal system for faster, easier installation, developed at DTU Construct in collaboration with Artlinco A/S."
...
showFeatured: true
---
**Bachelor's thesis (20 ECTS) · DTU Construct · Feb–May 2026**
**With:** Andreas Melvang · **Supervisor:** Niels Henrik Mortensen · **Industry partner:** Artlinco A/S

Terrace pedestals let you lay a raised tile terrace without pouring a concrete foundation - no digging, no drainage work, and easy access to whatever runs underneath. The problem is fine-adjustment: levelling dozens of individual feet by hand, one tile at a time, is slow and easy to get wrong. This project set out to redesign the pedestal itself to fix that.

### Process
- **Competitor analysis** of the terrace pedestals sold in Denmark
- **User survey** - 74% of private users rank ease of installation above price or looks
- **Product testing** - installed a small terrace with an off-the-shelf pedestal (Eurotec Pro) to time the process and log failure points
